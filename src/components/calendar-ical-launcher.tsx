  ...
  return (
    <>
      ...
      >
        ...
        {isSpanish ? "Conectar iCal" : "Connect iCal"}
      </button>

      <Modal open={isOpen} title={isSpanish ? "Conectar iCal" : "Connect iCal"} onClose={() => setIsOpen(false)}>
        <form action={handleSubmit} className="space-y-5">
          <div className="workspace-soft-card rounded-[24px] p-5">
            <p className="text-sm font-semibold text-[var(--workspace-text)]">
              {isSpanish ? "Guarda una conexión de calendario real" : "Save a real calendar connection"}
            </p>
